...
class Proposal(Cascade):
    def __init__(self, model, seq_len, PE_dim=256, l3_sz=16 * 2**20):
        ...
        # just to make sure below multiplication are still working.
        self.P1 = max(1, self.P1)
        # assert self.P1 >= 1, print(self.P1) # My change

        # Do not use improper factorization
        if self.transformer.P // self.PE_dim > 0:
        ...
        # TODO: Fix
        assert self.P1 > 0 # should pass now
